...
if [ "$MODE" = "picktest" ]; then
    clang -std=c11 -g -O1 -fno-omit-frame-pointer \
        -fsanitize=address,undefined \
        -Wall -Wextra \
        scene.c material.c mesh.c gothic.c bvh.c nid.c sol_math.c pick_test.c \
        -o pick_test
...
if [ "$MODE" = "coltest" ]; then
    clang -std=c11 -g -O1 -fno-omit-frame-pointer \
        -fsanitize=address,undefined \
        -Wall -Wextra \
        collide.c scene.c material.c mesh.c gothic.c nid.c sol_math.c collide_test.c \
        -o collide_test
...
if [ "$MODE" = "skeltest" ]; then
    clang -std=c11 -g -O1 -fno-omit-frame-pointer \
        -fsanitize=address,undefined \
        -Wall -Wextra \
        skel.c glb.c json.c image.c mesh.c gothic.c sol_math.c skel_test.c \
        -o skel_test
...
if [ "$MODE" = "gothictest" ]; then
    clang -std=c11 -g -O1 -fno-omit-frame-pointer \
        -fsanitize=address,undefined \
        -Wall -Wextra \
        gothic.c mesh.c sol_math.c gothic_test.c \
        -o gothic_test
